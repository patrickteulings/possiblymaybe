...
/* harmony export */   "default": function() { return /* binding */ splt; }
/* harmony export */ });
...
const HomepageHero = (_elem) => {
    ...
    const docEl = document.querySelector('.animated-text--container');
    const textElements = containerEl.getElementsByTagName('div');
    let animInterval;
    let count = 0;
...
if (homepageHero) {
    const heroAnimation = (0,_components_HomepageHero__WEBPACK_IMPORTED_MODULE_5__.HomepageHero)(homepageHero);
