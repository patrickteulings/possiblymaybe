		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'possiblymaybe' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'possiblymaybe' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'possiblymaybe' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'possiblymaybe' ),
						'full'    => esc_html__( 'Full text', 'possiblymaybe' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-possiblymaybe-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			...
			$wp_customize->add_control(
				new Twenty_Twenty_One_Customize_Color_Control(
					...
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'possiblymaybe' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
